...
export const projects: ProjectSummary[] = [
  ...
  },
  {
    ...
    outcomes: [
      ...
      'Three CloudWatch alarms monitor Lambda error rate, p95 duration, and throttles in production.',
    ],
  },
  {
  ...
  },
  {
    ...
    outcomes: [
      'Every push to the app repo triggers a full build, GHCR push, and EC2 redeploy via Jenkins in ~60 seconds.',
